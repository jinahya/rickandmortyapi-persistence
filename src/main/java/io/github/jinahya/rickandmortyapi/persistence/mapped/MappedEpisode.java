...
import io.github.jinahya.rickandmortyapi.persistence.Episode_;
import io.github.jinahya.rickandmortyapi.persistence.Episode_AirDateConverter;
...
public abstract class MappedEpisode
     ...
     */
    public static final Comparator<MappedEpisode> COMPARING_ID = Comparator.comparing(MappedEpisode::getId);

    /**
     * A comparator compares with {@link Episode_#EPISODE} attributes.
     */
    public static final Comparator<MappedEpisode> COMPARING_EPISODE = Comparator.comparing(MappedEpisode::getEpisode);

    /**
     * A comparator compares with {@link Episode_#AIR_DATE_ISO_} attributes.
     */
    public static final Comparator<MappedEpisode> COMPARING_AIR_DATE_ISO_ =
            Comparator.comparing(MappedEpisode::getAirDateIso_);
    ...
    public final boolean equals(final Object obj) {
        if (!(obj instanceof MappedEpisode that)) {
            return false;
        }
    ...
    // --------------------------------------------------------------------------------------------- Jakarta-Persistence
    @PrePersist
    protected void doOnPrePersist() {
        resetEpisodeRelatedValues();
    }

    @PostPersist
    protected void doOnPostPersist() {
        // empty
    }

    @PostLoad
    protected void doOnPostLoad() {
        resetEpisodeRelatedValues();
    }

    @PreUpdate
    protected void doOnPreUpdate() {
        resetEpisodeRelatedValues();
    }

    @PostUpdate
    protected void doOnPostUpdate() {
        // empty
    }

    @PreRemove
    protected void doOnPreRemove() {
        // empty
    }

    @PostRemove
    protected void doOnPostRemove() {
        // empty
    }
     ...
     */
    MappedEpisode id(final Integer id) {
        setId(id);
        return this;
    }
    ...
    protected void setAirDate(final LocalDate airDate) {
    ...
    protected void setEpisode(final String episode) {
    ...
    protected void setAirDateIso_(final LocalDate _airDateIso) {
