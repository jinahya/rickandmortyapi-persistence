...
class LocalDateConverter_Test extends _StringConverter_Test<LocalDateConverter, LocalDate> {

    LocalDateConverter_Test() {
        super(LocalDateConverter.class, LocalDate.class);
    }
